...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with infinite turns drop from the queue because they aren't being re-enqueued.
    ...
    // Defect(s) Found: People with infinite turns dropped from the queue because they weren't being re-enqueued.
